    ...
    var methods = {
        ...
        getDefaults: function(bootstrap_version) {
            var default_settings = {
                ...
                navListContainerClass: "make-center col-xs-12 col-sm-12 col-md-6",
                navListWrapperClass: "",
    ...
    var change_page = function(container_id, previous_selection, current_selection, update_nav_items, trigger_change_page) {
        ...
        if(update_nav_items) {
            ...
            if(nav_start > 1) {
                ...
                nav_html += '<li><a id="' + nav_top_id + '" href="' + nav_url + '">' + '<span class="glyphicon glyphicon-chevron-left"></span>' + '</a></li>';
                nav_url = s.directURL ? s.directURL(nav_start - 1) : no_url;
                nav_html += '<li><a id="' + nav_prev_id + '" href="' + nav_url + '">' + '<span class="glyphicon glyphicon-chevron-left"></span><span class="glyphicon glyphicon-chevron-left"></span>' + '</a></li>';
            }
            // show nav pages
            ...
            if(nav_end < s.totalPages) {
                ...
                nav_html += '<li><a id="' + nav_next_id + '" href="' + nav_url + '">' + '<span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span>' + '</a></li>';
                nav_url = s.directURL ? s.directURL(s.totalPages) : no_url;
                nav_html += '<li><a id="' + nav_last_id + '" href="' + nav_url + '">' + '<span class="glyphicon glyphicon-chevron-right"></span>' + '</a></li>';
            }
